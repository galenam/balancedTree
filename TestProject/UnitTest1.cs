...
namespace TestProject
{
    public class UnitTest1
    {
        ...
        static List<Tuple<List<int>, string>> _sourceResult = new List<Tuple<List<int>, string>>
        {
            ...
            new Tuple<List<int>, string>(new List<int> {48, 78, 87, 1, 83, 100, 24, 26, 80, 69, 50, 45, 80, 85, 100, 78, 99, 91, 57, 43, 55, 75, 22, 71, 72, 95, 1  }, "47 16 1 9 23 19 31 77 71 91 89 98"),
